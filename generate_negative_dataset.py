...
def compile_negative_dataset(output_path='negative_vectors.npy', max_samples=100, sector=21):
    ...
    print(f"Attempting to download up to {max_samples} clean control star light curves...")
    for tic in clean_targets:
        if downloaded_count >= max_samples:
            break
